...
title('Calculated Divergence (Problem 2)')
xlabel('X-Axis')
ylabel('Y-Axis')
...
%caxis([-1 1])
title('Lab Divergence (Problem 2)')
xlabel('X-Axis')
ylabel('Y-Axis')
...
title('Calculated Curl (Problem 2)')
xlabel('X-Axis')
ylabel('Y-Axis')
